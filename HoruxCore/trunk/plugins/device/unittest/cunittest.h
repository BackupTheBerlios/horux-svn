...
class CUnitTest : public QObject, CDeviceInterface
{
  Q_OBJECT
  ...
  Q_CLASSINFO ( "PluginName", "unittest" );
  Q_CLASSINFO ( "PluginType", "device" );
  Q_CLASSINFO ( "PluginDescription", "Unit test device" );

public:
    CUnitTest( QObject *parent=0);
