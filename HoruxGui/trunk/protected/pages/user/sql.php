...
class SQL {
    ...
    const SQL_ADD_PERSON = "INSERT INTO hr_user (`name`,`firstname`,`street`,`city`,`country`,`zip`,`phone1`,`phone2`,`email1`,`email2`,`language`,`sex`,`department`,`firme`,`street_pr`,`npa_pr`,`city_pr`,`country_pr`,`picture`,`pin_code`) VALUES (:name,:firstname,:street,:city,:country,:zip,:phone1,:phone2,:email1,:email2,:language,:sex,:department,:firme,:street_pr,:npa_pr,:city_pr,:country_pr,:picture,:pin_code)";

    const SQL_GET_PERSON = "SELECT * FROM hr_user WHERE id=:id";
    const SQL_UPDATE_PERSON = "UPDATE hr_user SET `pin_code`=:pin_code,`name`=:name,`firstname`=:firstname,`street`=:street,`city`=:city,`country`=:country,`zip`=:zip,`phone1`=:phone1,`phone2`=:phone2,`email1`=:email1,`email2`=:email2,`language`=:language,`sex`=:sex,`department`=:department,`firme`=:firme,`street_pr`=:street_pr,`npa_pr`=:npa_pr,`city_pr`=:city_pr,`country_pr`=:country_pr,`picture`=:picture WHERE id=:id";
