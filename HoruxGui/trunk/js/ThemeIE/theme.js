...
var cmThemeIEHSplit = [_cmNoAction, '<td class="ThemeIEMenuItemLeft"></td><td colspan="2"><div class="ThemeIEMenuSplit"></div></td>'];
var cmThemeIEMainHSplit = [_cmNoAction, '<td class="ThemeIEMainItemLeft"></td><td colspan="2"><div class="ThemeIEMenuSplit"></div></td>'];
var cmThemeIEMainVSplit = [_cmNoAction, '&nbsp;'];
