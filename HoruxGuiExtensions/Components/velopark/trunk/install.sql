...
VALUES (NULL , 'Subscription', 'components.velopark.attribution', './protected/pages/components/velopark/assets/icon-16-ticket.jpg', 'Subscription of the user', 'velopark');
