...
class subscription extends PageList
{
	...
	{
        $sql = "SELECT * FROM  hr_vp_subscription ORDER BY name";
    ...
    public function onDelete($sender,$param)
    {
        ...
        if($koMsg !== '')
          ...
          $pBack = array('okMsg'=>Prado::localize('{n} subscription was deleted',array('n'=>$nDelete)));
